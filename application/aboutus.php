	...
	<li><a href="mywallet.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-book"></i> <span>My Wallet</span></a></li>
		...
		<li class="treeview active">
		  ...
		  <ul class="treeview-menu">
			...
			<li class="active"><a href="aboutus.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-circle-o"></i>Aboutus Settings</a></li>
			<li><a href="hiw.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-circle-o"></i>How System Works</a></li>
			<li><a href="faq.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-circle-o"></i>Faqs Settings</a></li>
...
<?php }}?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-gear"></i>&nbsp;About Us Setup
        <small>Control panel</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="dashboard.php?id=<?php echo $_SESSION['tid']; ?>"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active"> <a href="aboutus.php?id=<?php echo $_SESSION['tid']; ?>">About Us</a></li>
	...
	<div class="box">
	       ...
	       <div class="box-body">
            ...
            <h3 class="panel-title"><i class="fa fa-gear"></i> About Us Setup</h3>
            </div>
             <div class="box-body">
 
              
			  <?php
$se = mysqli_query($link, "SELECT * FROM aboutus") or die (mysqli_error($link));
...
?>
 ...
 <label for="inputName" class="col-sm-2 control-label">About us:</label>
 <div class="col-sm-10">
 <textarea name="about" id="editor1" rows="5" required><?php echo $about; ?></textarea>
 </div>
 </div>
 <div class="form-group">
 <div class="col-sm-offset-2 col-sm-10">
<br> <button type="submit" name="submit" class="btn btn-success"><i class="fa fa-save"></i>&nbsp;Update</button><br><br>
 </div>
 </div><br><br>
 </form>
<?php
